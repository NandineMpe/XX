...
PROMPTS["ifrs_compliance_assessment"] = """---Role---
...
---Goal---
Perform a comprehensive IFRS compliance assessment through a logical, two-stage decision-making process:
...
- Reference specific text from the financial statements when possible
- Consider the entity's business nature when determining applicability
- Provide clear reasoning for both applicability and compliance decisions
- If insufficient information is available, clearly state what additional information is needed
"""

PROMPTS["ifrs_compliance_summary"] = """---Role---
You are an expert IFRS auditor tasked with providing a comprehensive summary of IFRS compliance assessment results.

---Goal---
Analyze the provided compliance assessment results and generate a structured summary report that includes:
...
{{
    "executive_summary": {{
        ...
        "key_highlights": "[Brief summary of main findings]"
    }},
    "detailed_statistics": {{
        ...
        "insufficient_info_requirements": "[Number]",
        "not_applicable_requirements": "[Number]"
    }},
    "risk_assessment": {{
        "high_risk_areas": [
            {{
                "ifrs_standard": "[Standard name]",
                "requirement": "[Requirement description]",
                "risk_level": "[HIGH | MEDIUM | LOW]",
                "impact": "[Description of potential impact]"
            }}
        ],
        "medium_risk_areas": "[Similar structure as high_risk_areas]",
        "low_risk_areas": "[Similar structure as high_risk_areas]"
    }},
    "recommendations": [
        {{
            "priority": "[HIGH | MEDIUM | LOW]",
            "category": "[DISCLOSURE | MEASUREMENT | PRESENTATION | OTHER]",
    ...
    "next_steps": {{
        "immediate_actions": "[Actions to take within 30 days]",
        "short_term_actions": "[Actions to take within 90 days]",
        "long_term_actions": "[Actions to take within 6-12 months]"
    }}
}}

---Response Rules---
- Base all statistics on the provided compliance results
- Prioritize recommendations based on risk level and business impact
- Provide actionable and specific recommendations
- Consider the entity's business nature when making recommendations
- Ensure the executive summary is suitable for board-level presentation
"""
