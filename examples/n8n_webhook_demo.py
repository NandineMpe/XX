...
def send_n8n_webhook(
    ...
    """
    payload = {"content": content, "source": source, "content_type": content_type}
...
def demo_json_content():
    ...
    json_data = {
        ...
        "items": [
            {"product_id": "PROD001", "name": "Laptop", "quantity": 1, "price": 999.99},
            {"product_id": "PROD002", "name": "Mouse", "quantity": 2, "price": 25.50},
        ],
